...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/natural-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14497&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/natural-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `natural` can be installed with:

```
conda install natural
```

It is possible to list all of the versions of `natural` available on your platform with:
